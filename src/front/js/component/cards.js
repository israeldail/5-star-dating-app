    ...
    <div className="d-flex justify-content-evenly" id="threecards">
      <Fragment>
        {store.profile.map((profile, i) => {
          return (
            <Carousel
              style={{ width: "auto", maxHeight: "35rem", color: "white" }}
            >
              <Carousel.Item>
                <Card style={{ width: "18rem", background: "black",maxHeight: "45rem" }}>
                  <Card.Img
                    variant="top"
              ...
              <Carousel.Item>
                <Card style={{ width: "18rem", background: "black", height: "auto",maxHeight: "45rem" }}>
                  <Card.Img
                    variant="top"

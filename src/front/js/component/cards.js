...
export const Cards = () => {
  return (
    <Carousel style={{width: "25rem", height: "25rem"}}>
    <Carousel.Item>
    <Card style={{ width: "18rem" }}>
      <Card.Img variant="top" src="https://www.criticschoice.com/wp-content/uploads/avatars/610/58b5890a50cfc-bpfull.jpg" />
      <Card.Body>
    ...
    <Carousel.Item>
    <Card style={{ width: "18rem" }}>
      <Card.Img variant="top" src="https://yt3.ggpht.com/ytc/AKedOLTPFraXHuDi-6zpBkog_36Mt2PqL0EwOoQU_fneeg=s900-c-k-c0x00ffffff-no-rj" />
      <Card.Body>
        <Card.Title>Tarzann</Card.Title>
        <Card.Text>
